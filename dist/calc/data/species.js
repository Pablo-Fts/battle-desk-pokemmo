...
var BW_FINAL = (0, util_1.extend)(true, {}, BW, POKEMMO_SPECIES_PATCH);
var XY_PATCH = {
...
try {
    for (var _c = __values(Object.entries(SV)), _d = _c.next(); !_d.done; _d = _c.next()) {
        var _e = __read(_d.value, 2), name_1 = _e[0], specie = _e[1];
...
exports.SPECIES = [CHAMPIONS, RBY, GSC, ADV, DPP, BW_FINAL, XY, SM, SS, SV];
